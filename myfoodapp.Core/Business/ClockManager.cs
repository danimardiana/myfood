    ...
    public class ClockManager
    {
        ...
        private void Connect()
        {
            ...
            try
            {
                ...
                var settings = new I2cConnectionSettings(1, rtcAddress);

                i2cbus = I2cDevice.Create(settings);    /* Create an I2cDevice with our selected bus controller and I2C settings */
                if (i2cbus != null)
                {
